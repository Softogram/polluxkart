...
> - PolluxKart runs Java 25, not Java 17.
> - Idempotency records live in the owning service's own schema under a UNIQUE constraint, written in the same transaction as the change (`polluxkart-postgres-jpa`).
