...
How the whole system fits together, across every service.
The engineering counterpart to [product/](../product/README.md).
...
- [cost.md](cost.md) - what it costs to run each month, and what makes it grow
- [runbook.md](runbook.md) - operating it: the current state, where private operational details live, and what to do when something breaks

## See also (do not follow recursively)

- [../design/high-level/README.md](../design/high-level/README.md) - the plans behind this: service boundaries, data model, order lifecycle, infrastructure
- [../services/README.md](../services/README.md) - the per-service detail this branch only summarizes
